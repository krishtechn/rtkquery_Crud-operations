...
const SignupForm = () => {
  ...
  return (
    <div className='flex justify-center items-center flex-col h-screen  w-full'>
       <form onSubmit={handleSubmit(onSubmit)} className='mt-5 w-[300px] shadow-2xl py-4 px-5'>
        ...
        <option value="other">other</option>
         ...
         <button className='bg-indigo-700 border-none outline-none w-full py-2 mt-5 rounded-full text-white'>Submit</button>
       </form>
